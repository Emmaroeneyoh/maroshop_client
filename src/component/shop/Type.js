...
import { GetProductType, GetProducttypeSize } from '../../redux/product'
...
function ProductType() {
  ...
  const handleXL = (e) => {
      ...
      const state = {type, size}
      dispatch(GetProducttypeSize(state))
  };
  ...
  <div class="input-group-append">
            ...
            <form class="mb-5">
                ...
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" value="xl" checked={isXl} onChange={handleXL} class="custom-control-input" id="size2" />
